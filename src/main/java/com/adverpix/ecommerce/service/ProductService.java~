...
public class ProductService {
    ...
    public Product addProductWithImage(Product product, MultipartFile image) throws IOException {
        ...
        if (categoryRepository.existsById(product.getCategory_id().getCategory_id()) && // we use getCategory_id() two times since it is a foreign key
                sellerRepository.existsById(product.getSeller_id().getSeller_id())) {
